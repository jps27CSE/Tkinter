...
def getval():
    print("Submitted")
    print(f"{nameVal.get(),phoneVal.get(),genderVal.get(),locationVal.get(),food_serviceVal.get()}")
    with open ("Records.doc","a") as f:
        f.write(f"{nameVal.get(),phoneVal.get(),genderVal.get(),locationVal.get(),food_serviceVal.get()}\n")
